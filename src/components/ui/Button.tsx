...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  success:
    "bg-green-500 text-white hover:bg-green-600 active:bg-green-700 disabled:bg-green-200",
  secondary:
    "bg-gray-200 text-gray-700 hover:bg-gray-300 active:bg-gray-400 disabled:bg-gray-100 disabled:text-gray-400",
  danger:
    "bg-red-500 text-white hover:bg-red-600 active:bg-red-700 disabled:bg-red-200",
  ghost:
    "bg-transparent text-gray-600 hover:bg-gray-100 active:bg-gray-200 border border-gray-300",
};
